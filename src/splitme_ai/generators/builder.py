...
class MkDocsConfig:
    """
    Handles MkDocs configuration generation with enhanced validation and customization.
    """
    ...
    def __init__(
        ...
        site_name: str = "MkDocs Documentation Site",
        enable_material: bool = True,
        theme_palette: Optional[Dict[str, str]] = None,
    ) -> None:
        """
        Initialize MkDocs configuration generator.

        Args:
            docs_dir: Directory containing documentation files
            site_name: Name of the documentation site
            enable_material: Whether to use Material theme
            theme_palette: Color palette configuration for Material theme
        """
        ...
        _logger.debug(
            f"Initialized MkDocs config with site_name='{self.site_name}', "
    ...
    def _generate_nav(self) -> List[Dict[str, str]]:
        ...
        try:
            ...
            if not md_files:
                _logger.warning(f"No markdown files found in {self.docs_dir}")
                return nav
            ...
            _logger.error(f"Failed to generate navigation structure: {e}")
    ...
    def _get_base_config(self) -> Dict[str, Any]:
        ...
        config = {
            ...
            "theme": {"name": "material", "logo": None, "icon": None, "palette": {}},
    ...
    def generate_config(
        ...
        try:
            ...
            _logger.info(f"Generating MkDocs configuration at {output_path}")
